...
export default {
  en: {
    ...
    CHARTS: {
      ...
      LINE: {
        ...
        CARD_SUBTITLE: 'Track your investment growth over time with interactive zoom controls',
        TOOLTIP_TOTAL_INVESTMENT: 'Total Investment',
        TOOLTIP_CHANGE: 'Change',
        TOOLTIP_PERCENTAGE: 'Percentage',
      },
      PORTFOLIO: {
        TITLE: 'Portfolio Distribution',
        SUBTITLE: 'Current allocation breakdown',
        TOTAL_INVESTMENT: 'Total Investment',
        TOTAL_REVENUE: 'Total Revenue',
        INVESTMENT_ENTRIES: 'Investment Entries',
        PERIOD: 'Period',
        NO_TIMELINE_TITLE: 'No Investment Timeline Available',
        NO_TIMELINE_TEXT: 'Add investment contributions with dates to see your investment progression timeline with zoom controls',
      },
    },
    PROFILE: {
      OFFLINE: {
  ...
  es: {
    ...
    SETTINGS: {
      ...
      MODAL: {
        ADD_SAVING: 'Añadir la aportación realizada',
        DATE: '¿Cuando añadiste los fondos?',
        TOOLTIPS: {
    ...
    CHARTS: {
      TITLE: 'Gráficas',
      SUBTITLE: 'Tus finanzas a un vistazo',
      DOUGHNUT: {
        SAVING: 'Aportaciones',
        PROFIT: 'Rentabilidad',
      },
      LINE: {
        ...
        CARD_SUBTITLE: 'Rastrea el crecimiento de tu inversión a lo largo del tiempo con controles de zoom interactivos',
        TOOLTIP_TOTAL_INVESTMENT: 'Inversión Total',
        TOOLTIP_CHANGE: 'Cambio',
        TOOLTIP_PERCENTAGE: 'Porcentaje',
      },
      PORTFOLIO: {
        TITLE: 'Distribución del Portfolio',
        SUBTITLE: 'Desglose de asignación actual',
        TOTAL_INVESTMENT: 'Inversión Total',
        TOTAL_REVENUE: 'Ingresos Totales',
        INVESTMENT_ENTRIES: 'Entradas de Inversión',
        PERIOD: 'Período',
        NO_TIMELINE_TITLE: 'Cronología de Inversión No Disponible',
        NO_TIMELINE_TEXT: 'Añade contribuciones de inversión con fechas para ver tu cronología de progreso de inversión con controles de zoom',
      },
    },
    PROFILE: {
      OFFLINE: {
        TITLE: 'Haz click para iniciar sesión',
        TOOLTIPS: {
  ...
  fr: {
    ...
    SETTINGS: {
      ...
      TOOLTIPS: {
        ...
        SAVING: 'Ajout de la économies',
      },
      MODAL: {
        ADD_SAVING: 'Ajouter la économies',
        DATE: 'Quand ajoutez-vous les fonds?',
        TOOLTIPS: {
    ...
    CHARTS: {
      ...
      LINE: {
        ...
        CARD_SUBTITLE: 'Suivez la croissance de votre investissement au fil du temps avec des contrôles de zoom interactifs',
        TOOLTIP_TOTAL_INVESTMENT: 'Investissement Total',
        TOOLTIP_CHANGE: 'Changement',
        TOOLTIP_PERCENTAGE: 'Pourcentage',
      },
      PORTFOLIO: {
        TITLE: 'Distribution du Portefeuille',
        SUBTITLE: 'Répartition actuelle des allocations',
        TOTAL_INVESTMENT: 'Investissement Total',
        TOTAL_REVENUE: 'Revenus Totaux',
        INVESTMENT_ENTRIES: 'Entrées d\'Investissement',
        PERIOD: 'Période',
        NO_TIMELINE_TITLE: 'Chronologie d\'Investissement Non Disponible',
        NO_TIMELINE_TEXT: 'Ajoutez des contributions d\'investissement avec des dates pour voir votre chronologie de progression d\'investissement avec des contrôles de zoom',
      },
    },
    PROFILE: {
      OFFLINE: {
  ...
  de: {
    ...
    SETTINGS: {
      ...
      MODAL: {
        ADD_SAVING: 'Ajout de la dépense',
        DATE: 'Wann hast du die Gelds ausgegeben?',
        TOOLTIPS: {
          HISTORY: 'Zeige Historie',
    ...
    CHARTS: {
      ...
      LINE: {
        ...
        SAVINGS_PROGRESSION: 'Kumulative Investition',
        DATE_AXIS: 'Datum',
        AMOUNT_AXIS: 'Gesamt Investiert',
        CARD_TITLE: 'Investitions-Zeitlinie',
        CARD_SUBTITLE: 'Verfolgen Sie das Wachstum Ihrer Investitionen im Laufe der Zeit mit interaktiven Zoom-Kontrollen',
        TOOLTIP_TOTAL_INVESTMENT: 'Gesamtinvestition',
        TOOLTIP_CHANGE: 'Änderung',
        TOOLTIP_PERCENTAGE: 'Prozentsatz',
      },
      PORTFOLIO: {
        TITLE: 'Portfolio-Verteilung',
        SUBTITLE: 'Aktuelle Allokationsaufschlüsselung',
        TOTAL_INVESTMENT: 'Gesamtinvestition',
        TOTAL_REVENUE: 'Gesamterlöse',
        INVESTMENT_ENTRIES: 'Investitionseinträge',
        PERIOD: 'Zeitraum',
        NO_TIMELINE_TITLE: 'Keine Investitions-Zeitlinie Verfügbar',
        NO_TIMELINE_TEXT: 'Fügen Sie Investitionsbeiträge mit Daten hinzu, um Ihre Investitionsfortschritt-Zeitlinie mit Zoom-Kontrollen zu sehen',
      },
    },
    PROFILE: {
      OFFLINE: {
        TITLE: 'Klicken um sich zu verbinden',
        TOOLTIPS: {
          LOGIN: 'Verbinden',
        },
      },
      ONLINE: {
        TITLE: 'Informationen',
        SUBTITLE: 'Deine persönlichen Daten',
        TOOLTIPS: {
  ...
  pt: {
    ...
    SETTINGS: {
      ...
      MODAL: {
        ADD_SAVING: 'Adicionar saldo',
        DATE: 'Quando adicionou o saldo?',
        TOOLTIPS: {
    ...
    CHARTS: {
      ...
      LINE: {
        TITLE: 'Crescimento de Investimento ao Longo do Tempo',
        SAVINGS_PROGRESSION: 'Investimento Cumulativo',
        DATE_AXIS: 'Data',
        AMOUNT_AXIS: 'Total Investido',
        CARD_TITLE: 'Cronologia de Investimento',
        CARD_SUBTITLE: 'Acompanhe o crescimento do seu investimento ao longo do tempo com controles de zoom interativos',
        TOOLTIP_TOTAL_INVESTMENT: 'Investimento Total',
        TOOLTIP_CHANGE: 'Mudança',
        TOOLTIP_PERCENTAGE: 'Porcentagem',
      },
      PORTFOLIO: {
        TITLE: 'Distribuição do Portfólio',
        SUBTITLE: 'Detalhamento da alocação atual',
        TOTAL_INVESTMENT: 'Investimento Total',
        TOTAL_REVENUE: 'Receita Total',
        INVESTMENT_ENTRIES: 'Entradas de Investimento',
        PERIOD: 'Período',
        NO_TIMELINE_TITLE: 'Cronologia de Investimento Não Disponível',
        NO_TIMELINE_TEXT: 'Adicione contribuições de investimento com datas para ver sua cronologia de progresso de investimento com controles de zoom',
      },
    },
    PROFILE: {
      OFFLINE: {
        TITLE: 'Clique para se conectar',
        TOOLTIPS: {
          LOGIN: 'Conectar',
        },
      },
  ...
  ru: {
    ...
    SETTINGS: {
      ...
      MODAL: {
        ADD_SAVING: 'Добавить списание',
        DATE: 'Когда добавили деньги?',
        TOOLTIPS: {
    ...
    CHARTS: {
      ...
      LINE: {
        TITLE: 'Рост Инвестиций со Временем',
        SAVINGS_PROGRESSION: 'Накопительные Инвестиции',
        DATE_AXIS: 'Дата',
        AMOUNT_AXIS: 'Всего Инвестировано',
        CARD_TITLE: 'Хронология Инвестиций',
        CARD_SUBTITLE: 'Отслеживайте рост ваших инвестиций со временем с интерактивными элементами управления масштабом',
        TOOLTIP_TOTAL_INVESTMENT: 'Общие Инвестиции',
        TOOLTIP_CHANGE: 'Изменение',
        TOOLTIP_PERCENTAGE: 'Процент',
      },
      PORTFOLIO: {
        TITLE: 'Распределение Портфеля',
        SUBTITLE: 'Текущая разбивка распределения',
        TOTAL_INVESTMENT: 'Общие Инвестиции',
        TOTAL_REVENUE: 'Общий Доход',
        INVESTMENT_ENTRIES: 'Записи Инвестиций',
        PERIOD: 'Период',
        NO_TIMELINE_TITLE: 'Хронология Инвестиций Недоступна',
        NO_TIMELINE_TEXT: 'Добавьте вклады в инвестиции с датами, чтобы увидеть хронологию прогресса ваших инвестиций с элементами управления масштабом',
      },
    },
    PROFILE: {
      OFFLINE: {
        TITLE: 'Нажмите для подключения',
        TOOLTIPS: {
          LOGIN: 'Подключиться',
        },
      },
  ...
  pl: {
    ...
    SETTINGS: {
      ...
      MODAL: {
        ADD_SAVING: 'Dodaj saldo',
        DATE: 'Gdzie dodano saldo?',
        TOOLTIPS: {
          HISTORY: 'Wyświetl historię',
          SAVE: 'Zapisz dane',
        },
        TABLE: {
          DATE: 'DATA',
    ...
    CHARTS: {
      ...
      LINE: {
        TITLE: 'Wzrost Inwestycji w Czasie',
        SAVINGS_PROGRESSION: 'Skumulowane Inwestycje',
        DATE_AXIS: 'Data',
        AMOUNT_AXIS: 'Łącznie Zainwestowano',
        CARD_TITLE: 'Oś Czasu Inwestycji',
        CARD_SUBTITLE: 'Śledź wzrost swoich inwestycji w czasie za pomocą interaktywnych kontrolek powiększenia',
        TOOLTIP_TOTAL_INVESTMENT: 'Łączne Inwestycje',
        TOOLTIP_CHANGE: 'Zmiana',
        TOOLTIP_PERCENTAGE: 'Procent',
      },
      PORTFOLIO: {
        TITLE: 'Dystrybucja Portfela',
        SUBTITLE: 'Bieżący podział alokacji',
        TOTAL_INVESTMENT: 'Łączne Inwestycje',
        TOTAL_REVENUE: 'Łączne Przychody',
        INVESTMENT_ENTRIES: 'Wpisy Inwestycyjne',
        PERIOD: 'Okres',
        NO_TIMELINE_TITLE: 'Oś Czasu Inwestycji Niedostępna',
        NO_TIMELINE_TEXT: 'Dodaj wkłady inwestycyjne z datami, aby zobaczyć oś czasu postępu swoich inwestycji z kontrolkami powiększenia',
      },
    },
    PROFILE: {
      OFFLINE: {
        TITLE: 'Kliknij aby połączyć się',
        TOOLTIPS: {
          LOGIN: 'Połącz',
        },
      },
  ...
  it: {
    ...
    CHARTS: {
      ...
      LINE: {
        TITLE: 'Crescita degli Investimenti nel Tempo',
        SAVINGS_PROGRESSION: 'Investimento Cumulativo',
        DATE_AXIS: 'Data',
        AMOUNT_AXIS: 'Totale Investito',
        CARD_TITLE: 'Cronologia degli Investimenti',
        CARD_SUBTITLE: 'Traccia la crescita dei tuoi investimenti nel tempo con controlli di zoom interattivi',
        TOOLTIP_TOTAL_INVESTMENT: 'Investimento Totale',
        TOOLTIP_CHANGE: 'Cambiamento',
        TOOLTIP_PERCENTAGE: 'Percentuale',
      },
      PORTFOLIO: {
        TITLE: 'Distribuzione del Portafoglio',
        SUBTITLE: 'Ripartizione dell\'allocazione attuale',
        TOTAL_INVESTMENT: 'Investimento Totale',
        TOTAL_REVENUE: 'Ricavi Totali',
        INVESTMENT_ENTRIES: 'Voci di Investimento',
        PERIOD: 'Periodo',
        NO_TIMELINE_TITLE: 'Cronologia degli Investimenti Non Disponibile',
        NO_TIMELINE_TEXT: 'Aggiungi contributi di investimento con date per vedere la cronologia del progresso dei tuoi investimenti con controlli di zoom',
      },
    },
    PROFILE: {
      OFFLINE: {
